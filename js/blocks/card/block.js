...
(function ( blocks, components, element, i18n ) {
	...
	var customIcon = el(
		'svg',
		{ width: 20, height: 20, className: "dashicon" },
	...
	function shortcodeEditorPreview( args ) {
		...
		if (args.link) {
			...
			return el(
				 'div',
				{ className: 'uri-gutenberg-shortcode-card' },
	...
	function renderHTML( args ) {
		...
		if (args.link) {
			...
			return el(
				 'a',
				{ className: classes , href: args.link },
		 ...
		 'uri-gutenberg/card',
		{
			...
			edit: function( props ) {
				...
				function createForm( ) {
					...
					return el(
					 'a',
					{ className: 'cl-card has-focus', href: '#' },
					el(
